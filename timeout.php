...
<body class="lock-screen" onload="startTime()">
    ...
    <div class="lock-wrapper">
        ...
        <div class="lock-box text-center">
            <div class="lock-name"><?php echo $_GET['user']?></div>
            <img src="template/images/lock_thumb.jpg" alt="lock avatar"/>
            <div class="lock-pwd">
                <form role="form" class="form-inline" action="class/process.class.php" method="post">
                    <div class="form-group">
                        <input type="password" placeholder="Password" id="exampleInputPassword2" class="form-control lock-input" name="pass">
